...
<div style="display: flex; justify-content: center; align-items: center; gap: 10px;">
  <img src="/assets/Toolkitimages/GP/Gppictire.jpg" alt="GP1" style="width: 50%; height: 50%; object-fit: contain;">
</div>
<div class="caption" style="text-align: center; margin-top: 8px;">
  تصویری از دانشجویان در کلاس
</div>
...
تشکر ویژه از استاد درس یادگیری ماشین دکتر هادی صادقی یزدی به خاطر راهنمایی‌ها و همکاری‌های ایشان.
