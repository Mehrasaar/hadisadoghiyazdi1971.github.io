...
## مرحله 1 — Forward Pass

ورودی → لایه‌ها → logits → softmax/sigmoid → y_hat
...
loss = CrossEntropy(y_hat , y_true)


---

## مرحله 3 — Backpropagation

از لایه آخر شروع می‌شود:
...
## مرحله 4 — به‌روزرسانی وزن‌ها

$$
W_l ← W_l - η (delta_l × activation_{l-1}^T)
$$

---

# فرم Batch در شبکه عمیق

برای یک مینی‌بتچ:

$$
Loss = - \frac{1}{N} \sum_{samples} \sum_{classes} y \log(\hat y)
$$

---

# چرا Cross-Entropy در شبکه‌های عمیق استاندارد است؟

## ✅ گرادیان قوی‌تر از MSE
MSE با سیگموید/سافت‌مکس → گرادیان ضعیف

---

## ✅ سازگار با احتمال
مدل خروجی احتمال می‌دهد → Cross-Entropy معیار طبیعی فاصله احتمالاتی است

---

## ✅ ارتباط با Maximum Likelihood

کمینه کردن Cross-Entropy = بیشینه کردن درست‌نمایی داده

---

## ✅ پایداری عددی بهتر
پیاده‌سازی‌ها معمولاً از نسخه پایدار استفاده می‌کنند:
